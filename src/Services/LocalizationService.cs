    ...
    public static class LocalizationService
    {
        ...
        private static Dictionary<string, string> CreateDefaultEnglishTranslations()
        {
            return new Dictionary<string, string>
            {
                ...
                ["help_usage"] = "help --system\nhelp --verified --thirdparty\nhelp update\nhelp new",
                ...
                // Config command
                ["config_description"] = "Manage application configuration settings",
                ["config_usage"] = "config get <key>\nconfig set <key> <value>\nconfig export\nconfig import <data>",
                ["config_invalid_command"] = "Invalid config command. Use: get|set|list",
                ["config_group_core"] = "Core Settings",
                ["config_group_color"] = "Color Settings",
                ["config_group_advanced"] = "Advanced Settings",
                ["config_group_system"] = "System Info",
                ["config_readonly"] = "Read-Only",
                ["config_setting"] = "Setting",
                ["config_value"] = "Current Value",
                ["config_readonly_header"] = "Read Only",
                ["config_unknown_key"] = "Unknown config key: {0}",
                ["config_updated"] = "Updated {0} = {1}",
                ["config_changed_log"] = "Config changed: {0} = {1}",
                ["config_readonly_error"] = "Cannot set read-only key: {0}",
                ["config_set_error"] = "Failed to set {0}: {1}",
                ["config_set_error_log"] = "Failed to set config",
                ["yes"] = "Yes",
                ["no"] = "No",
                ["config_export_success"] = "Configuration exported successfully. Use this code to import settings on another device:",
                ["config_export_error"] = "Configuration export failed: {0}",
                ["config_import_success"] = "Successfully imported {0} configuration settings",
                ["config_import_error"] = "Configuration import failed: {0}",
                ["config_import_missing_data"] = "Missing import data",
                ["config_import_invalid_data"] = "Invalid import data format",
        ...
        private static Dictionary<string, string> CreateDefaultRussianTranslations()
        {
            return new Dictionary<string, string>
            {
                ...
                // Команда config
                ["config_description"] = "Управление настройками приложения",
                ["config_usage"] = "config get <key>\nconfig set <key> <value>\nconfig export\nconfig import <data>",
                ["config_invalid_command"] = "Недопустимая команда. Используйте: get|set|list",
                ["config_group_core"] = "Основные настройки",
                ["config_group_color"] = "Цветовые настройки",
                ["config_group_advanced"] = "Дополнительные настройки",
                ["config_group_system"] = "Системная информация",
                ["config_readonly"] = "Только для чтения",
                ["config_setting"] = "Настройка",
                ["config_value"] = "Текущее значение",
                ["config_readonly_header"] = "Только чтение",
                ["config_unknown_key"] = "Неизвестный параметр: {0}",
                ["config_updated"] = "Обновлено {0} = {1}",
                ["config_changed_log"] = "Настройка изменена: {0} = {1}",
                ["config_readonly_error"] = "Нельзя изменить параметр только для чтения: {0}",
                ["config_set_error"] = "Ошибка установки {0}: {1}",
                ["config_set_error_log"] = "Ошибка изменения настроек",
                ["yes"] = "Да",
                ["no"] = "Нет",
                ["config_export_success"] = "Настройки успешно экспортированы. Используйте этот код для импорта на другом устройстве:",
                ["config_export_error"] = "Ошибка экспорта настроек: {0}",
                ["config_import_success"] = "Успешно импортировано {0} настроек",
                ["config_import_error"] = "Ошибка импорта настроек: {0}",
                ["config_import_missing_data"] = "Отсутствуют данные для импорта",
                ["config_import_invalid_data"] = "Неверный формат данных для импорта",
